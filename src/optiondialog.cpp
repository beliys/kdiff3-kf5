    ...
    KPageDialog( parent )
{
   ...
   setObjectName( name );
   setModal( true  );
// TODO  setHelp( "kdiff3/index.html", QString::null );
...
void OptionDialog::setupFontPage( void )
{
   ...
   pageItem->setIcon(QIcon::fromTheme("font-select-symbolic"));
   pageItem->setHeader( i18n("Editor & Diff Output Font" ) );
   // TODO KF5 pageItem->setIcon( KIcon( "preferences-desktop-font" ) );
   addPage( pageItem );

   QVBoxLayout *topLayout = new QVBoxLayout( page );
   topLayout->setMargin( 5 );
   // TODO KF5 topLayout->setSpacing( spacingHint() );
...
void OptionDialog::setupColorPage( void )
{
   ...
   pageItem->setIcon(QIcon::fromTheme("colormanagement"));
   pageItem->setHeader( i18n("Colors Settings") );
   // TODO KF5 pageItem->setIcon( KIcon("preferences-desktop-color") );
   addPage( pageItem );
...
void OptionDialog::setupEditPage( void )
{
   ...
   pageItem->setIcon(QIcon::fromTheme("accessories-text-editor"));
   pageItem->setHeader( i18n("Editor Behavior") );
   // TODO KF5 pageItem->setIcon( KIcon( "accessories-text-editor") );
   addPage( pageItem );
...
void OptionDialog::setupDiffPage( void )
{
   ...
   pageItem->setIcon(QIcon::fromTheme("text-x-patch"));
   pageItem->setHeader( i18n("Diff Settings") );
   // TODO KF5 pageItem->setIcon( KIcon( "preferences-other" ) );
   addPage( pageItem );
...
void OptionDialog::setupMergePage( void )
{
   ...
   pageItem->setIcon(QIcon::fromTheme("merge"));
   pageItem->setHeader( i18n("Merge Settings") );
   // TODO KF5 pageItem->setIcon( KIcon( "plasmagik" ) );
   addPage( pageItem );
   ...
   ++line;
   {
      ...
      // TODO KF5 gbox->setMargin(spacingHint());
...
void OptionDialog::setupDirectoryMergePage( void )
{
   ...
   pageItem->setIcon(QIcon::fromTheme("inode-directory"));
   pageItem->setHeader( i18n("Directory") );
   // TODO KF5 pageItem->setIcon( KIcon( "folder" ) );
   addPage( pageItem );
...
// TODO pBGLayout->setMargin(spacingHint());
...
void OptionDialog::setupRegionalPage( void )
{
   ...
   pageItem->setIcon(QIcon::fromTheme("preferences-desktop-locale"));
   pageItem->setHeader( i18n("Regional Settings") );
   // TODO KF5 pageItem->setIcon( KIcon("locale" ) );
   addPage( pageItem );
...
void OptionDialog::setupIntegrationPage( void )
{
   ...
   pageItem->setIcon(QIcon::fromTheme("utilities-terminal"));
   pageItem->setHeader( i18n("Integration Settings") );
   // TODO KF5 pageItem->setIcon( KIcon( "preferences-desktop-launch-feedback" ) );
   addPage( pageItem );
