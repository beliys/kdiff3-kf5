...
KDiff3Part::KDiff3Part(QCommandLineParser *cmdLineParser, QWidget *parentWidget, const char *widgetName,
                       QObject *parent)
    : KParts::ReadWritePart(parent)
{
    // we need an instance
    // TODO KF5 setComponentData( *KDiff3PartFactory::instance() );

    // this should be your custom internal widget
    m_widget = new KDiff3App(cmdLineParser, parentWidget, widgetName, this);
...
KDiff3Part::~KDiff3Part()
{
   ...
   {
      m_widget->saveOptions( m_widget->isPart() ? KSharedConfig::openConfig(QStringLiteral("kdiff3_part.rc")) : KSharedConfig::openConfig(QStringLiteral("kdiff3_shell.rc")) );
   }
}
