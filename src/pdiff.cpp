...
void KDiff3App::slotConfigure()
{
   ...
   // TODO KF5 m_pOptionDialog->incrementInitialSize ( QSize(0,40) );
...
{
    // TODO KF5 KShortcutsDialog::configure(actionCollection(), KShortcutsEditor::LetterShortcutsAllowed, this);
}
