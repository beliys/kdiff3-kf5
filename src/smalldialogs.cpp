...
: QDialog( pParent )
{
   ...
   m_pLineA->setEditText( n1 /** TODO KF5 beautification through QFileInfo? */ );
   ...
   m_pLineB->setEditText( n2 /** TODO KF5 beautification through QFileInfo? */ );
   ...
   m_pLineC->setEditText( n3 /** TODO KF5 beautification through QFileInfo? */ );
   ...
   m_pLineOut->setEditText( outputName /** TODO KF5 beautification through QFileInfo? */);
...
void OpenDialog::selectURL( QComboBox* pLine, bool bDir, int i, bool bSave )
{
   ...
   QUrl currentUrl = QUrl::fromUserInput(current, QString(), QUrl::AssumeLocalFile);
   ...
   QUrl newURL = bDir ? QFileDialog::getExistingDirectory(this, i18n("Open Directory"), current)
   ...
   if ( !newURL.isEmpty() )
   {
      newURL.isLocalFile() ? pLine->setEditText(newURL.path()) : pLine->setEditText(newURL.url());
   }
